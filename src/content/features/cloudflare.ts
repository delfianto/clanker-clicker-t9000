  ...
  Array.prototype.push = function (...args: unknown[]): number {
    ...
    if (Array.isArray(item) && item[0] && typeof item[0] === 'object' && 'isTrusted' in item[0]) {
      item[0] = {
        ...
        clientX: '30', clientY: '35', height: '1', isPrimary: 'false', isTrusted: 'true',
        layerX: '13', layerY: '14', movementX: '0', movementY: '0',
        offsetX: '13', offsetY: '15', pageX: '30', pageY: '35',
        pointerId: '1', pointerType: 'mouse', pressure: '0',
        relatedTarget: 'null', screenX: '203', screenY: '685',
        srcElement: '[object HTMLInputElement]', tangentialPressure: '0',
        target: '[object HTMLInputElement]', timeStamp: String(Date.now() + Math.random()),
        type: 'click', width: '1', x: '30', y: '35',
      };
